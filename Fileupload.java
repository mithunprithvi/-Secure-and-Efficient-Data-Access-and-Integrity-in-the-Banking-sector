...
public class Fileupload extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String fullpath=editpath+"Bank\\WebContent\\Local\\";
	...
	//file encrypted and store into filepath1
             ...
             filepath1 = editpath + "\\Bank\\WebContent\\Encrypt\\"+filename;
              ...
              //file decrypted and store into filepath2
        		    ...
        		    filepath2 = editpath + "\\Bank\\WebContent\\Decrypt\\"+filename;
     ...
     filepath1 = editpath + "\\Bank\\WebContent\\Encrypt\\"+filename;
      ...
      //file decrypted and store into filepath2
			...
			try {
				PreparedStatement pa=con.prepareStatement("SELECT prehash,afterhash FROM `bank`.`upload1` where useremail='"+oname+"'");
            ...
            up.setFilekey(paramValues.get(2).toString());
            ...
            up.setPrehash(prehash);
			up.setAfterhash(aphas);
